...
## Section 34
    provincialism   地方风格    
    contingent  偶然的；依情况而变的  contingency 意外事件
...
## Section 72
    ...
    jejune      浅薄的；幼稚的
    compose     组成；使安定
    flap        不安； flappable   flappability
    fawn        奉承  fawning
    clergy-man  牧师
    stereotype  陈词滥调    stereotyped 陈腐的
    loner       孤独的人
    ancillary   辅助的；附加的
    opprobrium  耻辱
    vituperation    辱骂
    lucubrate   刻苦用功    lucubration
    culprit     犯人
    heaven      天堂
    refuge      避难；避难所

## Section 73
    anecdote    趣事  anecdotal
    lapse       小错；过失
    utopia      乌托邦
    paradise    天堂；乐园
    circumstantial  详尽的；偶然的；依照情况而定的
    unsustainable   不能证实的   sustain
    eclectic    折中的  
...
## Section 74
    ...
    entreat     乞求  entreating
    bemoan      抱怨；哀悼
    heroine     女主角；    hero
    plod        沉重的走    plodding 沉重的；单调的
    deadpan     无表情的；不动声色的
